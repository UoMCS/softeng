...
:::{.rmdnote}
    ...
    You can obtain feedback throughout the coursework exercise by vieweing the RoboTA report in Jenkins.
:::
...
You *must* familiarise yourself with the [submission instructions](#submission-of-your-teams-work-imdone), in order to submit your work in the proper way. 
...
*Brain* is a Tech Lead at *Acme Solutions*, leading the development of the *Lab Escape Project*. He wanted to find all commits authored by his Junior Dev, *Pinky*.
He searches for all commits with the associated email address of `pinky@acme.com`, as per the company protocol on Git usage.

Last weekend, Pinky used his personal laptop to push some commits, and forgot to change the email address in his git configuration, meaning his commits were associated with `_xX_pinky_the_lab_mouse_Xx_@free-email-address.com`. Pinky's boss (rightfully) did not trust that these commits were authored by Pinky, who then faced disciplinary action.
...
**Commits made from other accounts (or aliases of your university account) will NOT be considered to be part of your team's submission for the exercise.<br/>Any individual who uses an incorrect email address will be given a mark of 0**
