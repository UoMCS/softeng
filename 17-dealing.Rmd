...
### Deliverables
Most deliverables for this exercise are held within your team's GitLab repository, except for the screencast video file:
- Selected Bugs
...
There are several penalties that may be incurred, details of these are given below:
...
|--------------------------------------------------|--------------------------------------------------|
| - Issue 1<br>- Issue 2<br>- Issue 3<br>- Issue 4 | - Issue 5<br>- Issue 6<br>- Issue 7<br>- Issue 8 |
...
- you must select which issues to fix, and which issues to ignore.
-  **you must select one or more issue(s) from Category B**
...
### Step Push to your Team's Development Branch {#stepeight}
...
- The video must begin with video footage of each team member introducing themself and describing, briefly, their role in the team. 
-  For each issue selected, the person who had responsibility for this issue must:
    - Explain the issue
    - Show in-game footage, with an explaination of the footage, confirming that the issue is fixed
...
- Shotcut (For very basic video editing)
...
The URL of your uploaded video must be placed in the follwing text file (which you must also create) on your GitLab repository: `doc/VIDEO_URL_1.txt`
