...
io_table <- tibble::tribble(
  ...
  "**1**: 26th Sept"            , "Automated build and test, see (ref:weekone)",  "IndCwk2, Fri 1st Oct, 6pm",
  "**2**: 3rd Oct"              , "Reading large codebases, see (ref:weektwo)",  "",
  "**3**: 10th Oct"             , "Debugging, see (ref:weekthree)", "IndCwk2, Fri 15th Oct, 6pm",
  "**4**: 17th Oct"             , "Cost estimation, see (ref:weekfour)",  "Mentoring week 1",
  "**5**: 24th Oct"             , "Test first development, see (ref:weekfive)", "TeamCwk1, 29th Oct, 6pm",
  ...
  "**10**: 28th Nov"            , "Design patterns, see (ref:weekten)", "TeamCwk2, Fri 3rd Dec, 6pm",
