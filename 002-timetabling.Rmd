...
1. **Team Study Tuesday**: Work on team coursework 1 (individually), see section \@ref(gitting)
1. **One off lecture** to introduce the course unit at 9am on Wednesday 29th September, check your timetable
1. **Workshop**: Automated build and test with Duncan Hull
1. **Team Study Thursday** Work on team coursework 1 (individually), see section \@ref(gitting)
