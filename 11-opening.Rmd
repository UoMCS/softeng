...
You'll also find Java projects listed on [up-for-grabs.net](http://up-for-grabs.net). You may also find ideas on at [twitter.com/yourfirstpr](https://twitter.com/yourfirstpr). Some more suggestions for open source projects, including many in Python and other langauges see *Coding Your Future*. [@experiencing]
