...
Hello, welcome and thanks for your interest in our software engineering mentoring program. This is an online event where software engineers can share their experience with undergraduate students as they fix bugs and add features to a large open source software project called [stendhalgame.org](https://stendhalgame.org/). If you are:
...
There are two one hour sessions timetabled, where you will meet with the same team on Zoom. Please only register if you can make BOTH of the sessions in the allotted time:
