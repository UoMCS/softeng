...
We expect that the web-based version of this manual will be the one you'll use most at \href{https://software-eng.netlify.app/}{software-eng.netlify.app}. You can search, browse and link to anything in the manual. It was last updated on 21 September, 2021.
...
\hypertarget{key}{%
\section{Key Information}\label{key}}
...
You'll submit your work through your own private GitLab repository. This has been created for you, and should be visible in your personal project list through the GitLab web interface at \href{gitlab.cs.man.ac.uk}{https://gitlab.cs.man.ac.uk}
