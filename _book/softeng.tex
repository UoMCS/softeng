...
We expect that the web-based version of this manual will be the one you'll use most at \href{https://software-eng.netlify.app/}{software-eng.netlify.app}. You can search, browse and link to anything in the manual. It was last updated on 27 September, 2021.
...
{\centering \includegraphics[width=0.75\linewidth]{images/covid_risk_chart} 

}

\caption{Just like life during a global pandemic, software engineering is inherently risky \href{https://xkcd.com/2333/}{COVID Risk Chart (xkcd.com/2333)} by \href{https://en.wikipedia.org/wiki/Randall_Munroe}{Randall Munroe} is licensed under \href{https://creativecommons.org/licenses/by-nc/2.5/}{CC BY-NC 2.5}}\label{fig:xkcd-risk-fig}
\end{figure}
...
For mentors, welcome and thanks for your interest in our software engineering mentoring program. This chapter is aimed primarily at \textbf{mentors not students} so if you're a student on this course you can go straight to chapter \ref{ourmentor} to find out more about how mentoring works.
...
\item
  what you get in return for volunteering, see \ref{payback}
\item
...
\tightlist
\item
  \textbf{Thursday 21st October 2021 at 11am}
\item
  \textbf{Thursday 18th November 2021 at 11am}
\end{enumerate}
...
We are looking for around 60 mentors in 2021, if we are oversubscribed we will give higher priority to:
...
\hypertarget{payback}{%
\section{What do you get in return?}\label{payback}}
...
\item
  Career development: its good for junior software engineers to demonstrate leadership and mentoring skills
\item
...
We would like to thank all of our partners and employers who have helped us to date including:

ARM, Avecto, Barclays, BBC, Blaize, Bloomberg, Booking.com, CDL Software, CodeThink, Code Computer Love, DataCentred, Digital Bridge Ltd, EGN Digital, Facebook, Farm Digital, Giant Digital, Goldman Sachs, Google, IBM, Koder.ly, Matillion, Morgan Stanley, NCC Group, On The Beach, Rental Cars, Sainsburys, Sage Group plc, Siemens (Mentor Graphics), SteamaCo, THG, ThoughtWorks and Zuhlke.
...
Your mentor is a professional software engineer from one of the employers listed here: ARM, Avecto, Barclays, BBC, Blaize, Bloomberg, Booking.com, CDL Software, CodeThink, Code Computer Love, DataCentred, Digital Bridge Ltd, EGN Digital, Facebook, Farm Digital, Giant Digital, Goldman Sachs, Google, IBM, Koder.ly, Matillion, Morgan Stanley, NCC Group, On The Beach, Rental Cars, Sainsburys, Sage Group plc, Siemens (Mentor Graphics), SteamaCo, THG, ThoughtWorks and Zuhlke.
...
\hypertarget{TFD}{%
\section{Test-First Development and Managing Conflicts}\label{TFD}}

\hypertarget{introt}{%
\subsection{Introduction}\label{introt}}
