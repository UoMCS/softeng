...
We expect that the web-based version of this manual will be the one you'll use most at \href{https://software-eng.netlify.app/}{software-eng.netlify.app}. You can search, browse and link to anything in the manual. It was last updated on 16 September, 2021.
...
\midrule
**0**: 20th Sept & Configuring, see section \ref{week0} & IndCwk1-S-Basic Git (premarked)\\
**1**: 27th Sept & Automated build and test, see see section \ref{week1} & IndCwk1-S-Basic Git (final)\\
**2**: 4th Oct & Reading large codebases, see see section \ref{week2} & \\
**3**: 11th Oct & Debugging, see see section \ref{week3} & TeamCwk1-S-Fixing Bugs\\
**4**: 18th Oct & Cost estimation, see see section \ref{week4} & \\
\addlinespace
**5**: 25th Oct & Test first development, see see section \ref{week5} & \\
**6**: 1st Nov & Git workflows, see see section \ref{week6} & IndCwk2-S-Conflicts in Git (premarked)\\
**7**: 8th Nov & Reading week see see section \ref{week7} & IndCwk2-S-Conflicts in Git (final)\\
**8**: 15th Nov & Software refactoring, see see section \ref{week8} & \\
**9**: 22nd Nov & Design for testability, see see section \ref{week9} & TeamCwk2-S-Adding Features\\
\addlinespace
**10**: 29th Nov & Design patterns, see see section \ref{week10} & \\
**11**: 6th Dec & Risk management and practice exam, see see section \ref{week11} & \\
**12**: 13th Dec & Open source challenge, see see section \ref{week8} & \\
\bottomrule
\end{tabular}
\end{table}
