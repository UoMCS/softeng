...
Your learning community is supported by a group of graduate teaching assistants (GTAs), mentors and academic staff. So for this course, here's what you can expect of us and what we expect of you:

\hypertarget{rtfm}{%
\section{Our expectations of you}\label{rtfm}}

We need you to read ALL of the messages we send you via gitlab, jenkins, microsoft teams, piazza forums, email and in this guidebook. Before you ask for help, make sure you Read The Friendly Manual(s). RTFM.

For online sessions (e.g.~marking and mentoring) you need to turn up on time by being at a computer with access to:
...
Please note, this may mean the best place to work is not the Kilburn building. Go and find a quiet spot or use your phone (there are good mobile clients for Teams) or work from home.
...
\hypertarget{urteam}{%
\section{What your team expects of you}\label{urteam}}
...
\hypertarget{gtas}{%
\section{What GTAs expect of you}\label{gtas}}
...
\section{What your mentors expect from you}\label{gomentors}}

You have been assigned a mentor who will meet with you online for two one hour meetings, see chapter \ref{mentoring}. These meetings are a bit like code review meetings, they have access to your code repository and can see what your team is up to.

Our mentors are all professional software engineers, so please treat them with the respect they deserve. They have volunteered to help by sharing their engineering wisdom with you and taken time out of their busy schedules to do so.

\hypertarget{academics}{%
\section{What you can expect from us}\label{academics}}

So what can you expect of us? The academic staff on this course include Suzanne Embury, Anas Elhag, Duncan Hull, Thomas Carroll, Sandra Sampaio and Mercedes. We're here to help. Please remember, we're often very busy and have other teaching commitments too besides this course. We're here to ensure that the course runs smoothly and we aim to feedback on coursework to you within the two week window
