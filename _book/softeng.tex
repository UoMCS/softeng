...
We expect that the web-based version of this manual will be the one you'll use most at \href{https://software-eng.netlify.app/}{software-eng.netlify.app}. You can search, browse and link to anything in the manual. It was last updated on 13 September, 2021.
...
\textbackslash caption\{\label{tab:schedtable}The weekly schedule for this twelve week course, please note we are using the week numbering from the \href{https://my.manchester.ac.uk/Timetable/2021_22/4614/}{my.manchester.ac.uk timetables} where week 1 is welcome week (rather than week 0)\}
\centering
...
**4**: 11th Oct & Cost estimation, see chapter \ref{estimating} & details tbc\\
**5**: 18th Oct & Test first development & details tbc\\
\addlinespace
**6**: 25th Oct & Git workflows & details tbc\\
**7**: 1st Nov & Software refactoring & details tbc\\
**8**: 8th Nov & Design for testability & details tbc\\
**9**: 15th Nov & Design patterns & details tbc\\
**10**: 22nd Nov & Risk management and practice exam & details tbc\\
\addlinespace
**11**: 29th Nov & Open source challenge & details tbc\\
**12**: 6th Dec & confirm when reading week is & details tbc\\
