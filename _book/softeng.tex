...
We expect that the web-based version of this manual will be the one you'll use most at \href{https://software-eng.netlify.app/}{software-eng.netlify.app}. You can search, browse and link to anything in the manual. It was last updated on 24 September, 2021.
...
X 10
Y 10
Z 6.00pm, Friday 1st October 2021
...
This coursework exercise consists of 9
(ref:ideversion) Eclipse 2020-03
(ref:repoURI) \url{https://gitlab.cs.man.ac.uk/comp23311_2021/sliding_puzzle_} steps. If you complete them all correctly, then you should earn full marks against the marking scheme shown in table \ref{tab:marktable}.
