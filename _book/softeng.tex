...
We expect that the web-based version of this manual will be the one you'll use most at \href{https://software-eng.netlify.app/}{software-eng.netlify.app}. You can search, browse and link to anything in the manual. It was last updated on 01 February, 2022.
...
\texttt{Document\ version:} 01 February, 2022
...
We're not going to be making any serious changes to the Marauroa code base in this workshop, so we will just ask for a remote tracking branch to be created for the \texttt{master} branch of the repository, see figure \ref{fig:selectMarauroaBranches-fig}. If you need to remind yourself how branches work, you might like to visit (or revisit) \href{https://learngitbranching.js.org/}{learngitbranching.js.org}.
