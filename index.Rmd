...
We expect that the web-based version published at of this manual will be the one you'll use most at [software-eng.netlify.app](https://software-eng.netlify.app/). You can search, browse and link to anything in the manual.
...
* Click on the `Edit this page` link, which appears on the bottom right hand side of every page published at [softeng.netlify.app](https://softeng.netlify.app) when viewed with a reasonably large screen (not a phone)
